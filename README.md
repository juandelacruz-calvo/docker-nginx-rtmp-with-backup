...
- https://github.com/ngoral/nginx-rtmp-backup
...
```
docker pull juanitolol/nginx-rtmp-backup-switch
docker run -it -p 1935:1935 -p 8080:80 --rm juanitolol/nginx-rtmp-backup-switch
```
or 
...
```
rtmp://<server ip>:1935/main/$STREAM_NAME
rtmp://<server ip>:1935/backup/$STREAM_NAME
```
...
* URL: `rtmp://localhost:1935/main` or `rtmp://localhost:1935/backup` 
* Stream Key: `hello`
